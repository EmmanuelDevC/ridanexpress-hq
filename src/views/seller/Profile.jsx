                        ...
                        <form onSubmit={submitBankDetails} className="space-y-4">
                            ...
                            <div className="flex justify-end space-x-3 pt-2">
                                ...
                                <button
                                    ...
                                    className={`flex items-center px-4 py-2 bg-gradient-to-r from-orange-600 to-amber-700 text-white rounded-lg hover:from-orange-500 hover:to-amber-600 transition-all ${sellerReducer.loader ? 'opacity-70 cursor-not-allowed' : ''
                                        }`}
                                >
